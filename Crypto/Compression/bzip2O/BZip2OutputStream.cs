namespace Yannick.Crypto.Compression.bzip2O
{
    ...
    internal class BZip2OutputStream : Stream
    {
        ...
        {
            if (last < allowableBlockSize && block != null)
            {
        ...
        private void SendMTFValues()
        {
            ...
            for (iter = 0; iter < BZip2Constants.NumberOfIterations; ++iter)
            {
                ...
                while (true)
                {
                    ...
                    if (szptr == null)
                        throw new NullReferenceException(nameof(szptr));
        ...
        {
            if (zptr == null)
                throw new NullReferenceException(nameof(zptr));
            ...
            while (sp > 0)
            {
                ...
                while (true)
                {
                    while (true)
                    {
                        ...
                        if (n == 0)
                        {
                            (zptr[unLo], zptr[ltLo]) = (zptr[ltLo], zptr[unLo]);
                            ltLo++;
                            unLo++;
                            continue;
                        }
                    ...
                    while (true)
                    {
                        ...
                        if (n == 0)
                        {
                            (zptr[unHi], zptr[gtHi]) = (zptr[gtHi], zptr[unHi]);
                            gtHi--;
                            unHi--;
                            continue;
                        }
                    ...
                    {
                        (zptr[unLo], zptr[unHi]) = (zptr[unHi], zptr[unLo]);
                        unLo++;
                        unHi--;
                    }
                }
        ...
        {
            if (block == null || zptr == null || ftab == null || quadrant == null)
        ...
        {
            if (block == null || szptr == null || zptr == null)
                throw new NullReferenceException();
        ...
        private int bsBuff;
        private int bsLive;
        private BZip2.IChecksum mCrc = new BZip2.BZip2Crc();
