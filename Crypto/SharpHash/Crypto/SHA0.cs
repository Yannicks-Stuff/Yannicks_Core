...
namespace Yannick.Crypto.SharpHash.Crypto
{
    ...
    {
        private static readonly uint C1 = 0x5A827999;
        private static readonly uint C2 = 0x6ED9EBA1;
        private static readonly uint C3 = 0x8F1BBCDC;
        private static readonly uint C4 = 0xCA62C1D6;
        ...
        {
            var result = new byte[5 * sizeof(uint)];

            fixed (uint* sPtr = state)
            {
