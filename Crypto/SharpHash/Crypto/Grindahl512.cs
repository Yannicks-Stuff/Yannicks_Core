...
namespace Yannick.Crypto.SharpHash.Crypto
{
    ...
    {
        private static ulong[] table_0 = new ulong[256];
        private static ulong[] table_1 = new ulong[256];
        private static ulong[] table_2 = new ulong[256];
        private static ulong[] table_3 = new ulong[256];
        private static ulong[] table_4 = new ulong[256];
        private static ulong[] table_5 = new ulong[256];
        private static ulong[] table_6 = new ulong[256];
        private static ulong[] table_7 = new ulong[256];

        private static readonly ulong[] master_table =
        {
            0xC6636397633551A2,
        ...
        {
            fixed (ulong* t0Ptr = table_0, t1Ptr = table_1, t2Ptr = table_2,
                   t3Ptr = table_3, t4Ptr = table_4, t5Ptr = table_5, t6Ptr = table_6,
                   t7Ptr = table_7, masterPtr = master_table)
            {
                Utils.Utils.Memmove((IntPtr)t0Ptr, (IntPtr)masterPtr, 256 * sizeof(ulong));
        ...
        {
            var HashInstance = new Grindahl512();
        ...
        {
            var padding_size = 16 - (int)(processed_bytes & 7);
            var msg_length = (processed_bytes >> 3) + 1;
        ...
        protected override void TransformBlock(IntPtr a_data,
