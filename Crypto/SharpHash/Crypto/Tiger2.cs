...
namespace Yannick.Crypto.SharpHash.Crypto
{
    ...
    {
        public static readonly string InvalidTiger2HashSize =
            "Tiger2 HashSize Must be Either 128 bit(16 byte), 160 bit(20 byte) or 192 bit(24 byte)";

        protected Tiger2(int a_hash_size, HashRounds a_rounds)
    ...
    {
        public Tiger2_Base(int a_hash_size, HashRounds a_rounds)
            : base(a_hash_size, a_rounds)
        {
        }
        ...
        {
            var HashInstance = new Tiger2_Base(HashSize, GetHashRound(rounds));
    ...
    internal sealed class Tiger2_128 : Tiger2
    {
        ...
        public override Interfaces.IHash? Clone()
        {
            var HashInstance = new Tiger2_128(HashSizeEnum.HashSize128, GetHashRound(rounds));
            HashInstance.buffer = buffer.Clone();
            HashInstance.processed_bytes = processed_bytes;
    ...
    internal sealed class Tiger2_160 : Tiger2
    {
        ...
        public override Interfaces.IHash? Clone()
        {
            var HashInstance = new Tiger2_160(HashSizeEnum.HashSize160, GetHashRound(rounds));
            HashInstance.buffer = buffer.Clone();
            HashInstance.processed_bytes = processed_bytes;
    ...
    internal sealed class Tiger2_192 : Tiger2
    {
        ...
        public override Interfaces.IHash? Clone()
        {
            var HashInstance = new Tiger2_192(HashSizeEnum.HashSize192, GetHashRound(rounds));
            HashInstance.buffer = buffer.Clone();
            HashInstance.processed_bytes = processed_bytes;
