...
namespace Yannick.Crypto.SharpHash.Crypto
{
    internal sealed class WhirlPool : BlockHash, ICryptoNotBuiltIn, ITransformBlock
    {
        ...
        private static readonly uint REDUCTION_POLYNOMIAL = 0x011D;

        private static ulong[] C0 = new ulong[256];
        private static ulong[] C1 = new ulong[256];
        private static ulong[] C2 = new ulong[256];
        private static ulong[] C3 = new ulong[256];
        private static ulong[] C4 = new ulong[256];
        private static ulong[] C5 = new ulong[256];
        private static ulong[] C6 = new ulong[256];
        private static ulong[] C7 = new ulong[256];
        private static ulong[] rc = new ulong[ROUNDS + 1];
        ...
        {
            var HashInstance = new WhirlPool();
