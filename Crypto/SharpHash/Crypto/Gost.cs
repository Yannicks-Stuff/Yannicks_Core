...
namespace Yannick.Crypto.SharpHash.Crypto
{
    internal sealed class Gost : BlockHash, ICryptoNotBuiltIn, ITransformBlock
    {
        ...
        {
            uint c, a, b;
            uint[] m = new uint[8], data = new uint[8];
