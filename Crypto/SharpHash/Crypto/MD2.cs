...
namespace Yannick.Crypto.SharpHash.Crypto
{
    internal sealed class MD2 : BlockHash, ICryptoNotBuiltIn, ITransformBlock
    {
        ...
        protected override void Finish()
        {
            ...
            padLen = 16 - (uint)buffer.Position;
            ...
            TransformBytes(pad, 0, (int)padLen);
            ...
            int a_data_length, int a_index)
        {
            ...
            fixed (byte* tempPtr = temp, statetPtr = state)
            {
                ...
                Utils.Utils.Memmove((IntPtr)(tempPtr + a_data_length), (IntPtr)((byte*)a_data + a_index),
                    a_data_length);
