...
namespace Yannick.Crypto.SharpHash.Hash32
{
    internal sealed class Jenkins3 : MultipleTransformNonBlock, IHash32, ITransformBlock
    {
        ...
        {
            int length, currentIndex, i1, i2, i3, i4;
            uint a, b, c;
            ...
            a = 0xDEADBEEF + (uint)length + (uint)InitialValue;
            b = a;
            c = b;
