...
namespace Yannick.Crypto.SharpHash.Utils
{
    internal static class LangBuilder
    {
        ...
        /// <returns></returns>
        public static Interfaces.IHash Reducer(string hash_string)
        {
        ...
        private static Interfaces.IHash Core(string hash_string)
        {
            var hash = Strip(hash_string);
            ...
            throw new NotImplementedHashLibException(
                $"Hash string: \"{hash_string}\" is unknown or not in correct format.");
        }
    }
}