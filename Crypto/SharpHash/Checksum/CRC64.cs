...
namespace Yannick.Crypto.SharpHash.Checksum
{
    ...
    {
        public static readonly ulong ECMA_182 = 0x42F0E1EBA9EA3693;
    } // end class CRC64Polynomials

    internal class CRC64 : Base.Hash, Interfaces.IChecksum, IBlockHash, IHash64, ITransformBlock
    {
        private ICRC CRCAlgorithm;

        public CRC64(ulong _poly, ulong _Init, bool _refIn, bool _refOut,
            ulong _XorOut, ulong _check, string[] _Names)
            : base(8, 1)
        {
    ...
    {
        public CRC64_ECMA_182() : base(CRC64Polynomials.ECMA_182, 0x0000000000000000, false, false, 0x0000000000000000,
            0x6C40DF5F0B497347, new[] { "CRC-64/ECMA" })
        {
        } // end constructor
