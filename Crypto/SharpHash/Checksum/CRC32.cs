...
namespace Yannick.Crypto.SharpHash.Checksum
{
    ...
    {
        public static readonly uint PKZIP = 0x04C11DB7;
        public static readonly uint Castagnoli = 0x1EDC6F41;
    } // end class CRC32Polynomials

    internal class CRC32 : Base.Hash, Interfaces.IChecksum, IBlockHash, IHash32, ITransformBlock
    {
        private ICRC CRCAlgorithm;

        public CRC32(ulong _poly, ulong _Init, bool _refIn, bool _refOut,
            ulong _XorOut, ulong _check, string[] _Names) : base(4, 1)
        {
    ...
    {
        public CRC32_PKZIP()
            : base(CRC32Polynomials.PKZIP, 0xFFFFFFFF, true, true, 0xFFFFFFFF, 0xCBF43926,
    ...
    internal sealed class CRC32_CASTAGNOLI : CRC32
    {
        public CRC32_CASTAGNOLI()
            : base(CRC32Polynomials.Castagnoli, 0xFFFFFFFF, true, true, 0xFFFFFFFF, 0xE3069283,
                new[] { "CRC-32C", "CRC-32/ISCSI", "CRC-32/CASTAGNOLI" })
        {
        } // end constructor
