...
{
    internal sealed class Adler32 : Base.Hash, Interfaces.IChecksum, IBlockHash, IHash32, ITransformBlock
    {
        ...
        {
            IHashResult result = new HashResult((int)((b << 16) | a));
