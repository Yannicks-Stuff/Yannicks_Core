...
{
    public struct Blowfish_CBC : Crypto.ISymmetric.ISupportKeyRange
    {
        internal class BlowFishEngine
        {
            ...
            const int
                ROUNDS = 16; //standard is 16, to increase the number of rounds, bf_P needs to be equal to the number of rouds. Use digits of PI.
            ...
            public BlowFishEngine(string hexKey)
            {
            ...
            public BlowFishEngine(byte[]? cipherKey)
            {
                randomSource = new RNGCryptoServiceProvider();
                SetupKey(cipherKey);
            }
        ...
        private BlowFishEngine Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght { get; private set; }
        public ushort? Published => 1993;
        public Range KeyRange => new Range(1, 56);

        public Blowfish_CBC(ushort keylenght = 56)
        {
            KeyLenght = keylenght;
            Key = Crypto.Hash.Decrypt<Keccak_512>(Password.Generate(64, 32).ToByteArray(Encoding.UTF8)).Take(KeyLenght)
                .ToArray();
            Provider = new BlowFishEngine(Key);
            Provider.SetRandomIV();
            IV = Provider.IV;
        }
        ...
        private void Init()
        {
            ...
            {
                KeyLenght = 56;
                Key = (Crypto.Hash.Decrypt<Keccak_512>(Password.Generate(64, 32).ToByteArray(Encoding.UTF8)) ??
        ...
        {
            Init();
            return Provider.Decrypt_CBC(data);
        }

        public byte[]? Encrypt(byte[]? data)
        {
            Init();
            return Provider.Encrypt_CBC(data);
        }
    ...
    public struct Blowfish_CBC_16 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght => 2;
        public ushort? Published => 1993;
        ...
        public byte[]? Decrypt(byte[]? key, byte[]? iv, byte[]? data)
        {
            ...
            IV = iv;
            Key = key;
            var rs = Provider!.Value.Decrypt(key, iv, data);
            return rs;
        }
        ...
        public byte[]? Encrypt(byte[]? key, byte[]? iv, byte[]? data)
        {
            ...
            IV = iv;
            Key = key;
            var rs = Provider!.Value.Encrypt(key, iv, data);
            return rs;
        }
    }

    public struct Blowfish_CBC_32 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght => 4;
        public ushort? Published => 1993;
    ...
    public struct Blowfish_CBC_64 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_CBC_128 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_CBC_192 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_CBC_256 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_CBC_384 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght => 48;
        public ushort? Published => 1993;
    ...
    public struct Blowfish_CBC_448 : Crypto.ISymmetric
    {
        private Blowfish_CBC? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght => 56;
        public ushort? Published => 1993;
    ...
    public struct Blowfish_ECB : Crypto.ISymmetric.ISupportKeyRange
    {
        private Blowfish_CBC.BlowFishEngine Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght { get; private set; }
        public ushort? Published => 1993;
        ...
        public Blowfish_ECB(ushort keylenght = 56)
        {
            KeyLenght = keylenght;
            Key = (Crypto.Hash.Decrypt<Keccak_512>(Password.Generate(64, 32).ToByteArray(Encoding.UTF8)) ??
                   throw new InvalidOperationException()).Take(KeyLenght).ToArray();
            Provider = new Blowfish_CBC.BlowFishEngine(Key);
            Provider.SetRandomIV();
            IV = Provider.IV;
        }
    ...
    public struct Blowfish_ECB_16 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
        public ushort KeyLenght => 2;
        public ushort? Published => 1993;
    ...
    public struct Blowfish_ECB_32 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_64 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_128 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_192 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_256 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_384 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
    ...
    public struct Blowfish_ECB_448 : Crypto.ISymmetric
    {
        private Blowfish_ECB? Provider;
        public byte[]? Key { get; private set; }
        public byte[]? IV { get; private set; }
